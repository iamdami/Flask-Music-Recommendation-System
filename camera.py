...
class FPS:
    def __init__(self):
        # 시작 시간, 종료 시간 및 총 프레임 수 저장
        # 시작 및 종료 간격 사이에 검사한 것
        self._start = None
        self._end = None
        self._numFrames = 0
    ...
    def update(self):
        # 시작과 끝 인터벌 동안 검사한 총 프레임 수 증가시킴
        self._numFrames += 1

    def elapsed(self):
        # 시작과 종료 간격 사이의 총 시간(초) 반환
...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        for (x, y, w, h) in face_rects:
            cv2.rectangle(image, (x, y - 50), (x + w, y + h + 10), (170, 130, 44), 2)
